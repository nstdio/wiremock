...
public class WireMockJUnitRuleTest {
    ...
    public static class WireMockRuleAsJUnit411ClassRule {
        ...
        @ClassRule
        public static WireMockClassRule classRule = new WireMockClassRule(wireMockConfig().dynamicPort());
    ...
    public static class WireMockJournalIsResetBetweenMultipleTestsWithWireMockRuleAsJUnit411ClassRule {
        ...
        @ClassRule
        public static WireMockClassRule wireMockRule1 = new WireMockClassRule(wireMockConfig().dynamicPort());
        @Rule
        public WireMockClassRule instancewireMockRule1 = wireMockRule1;

        @ClassRule
        public static WireMockClassRule wireMockRule2 = new WireMockClassRule(wireMockConfig().dynamicPort());
        @Rule
    ...
    public static class PortNumbers {
        ...
        @Rule
        public WireMockRule wireMockRule = new WireMockRule(wireMockConfig().port(RULE_HTTP_PORT).httpsPort(RULE_HTTPS_PORT));

        @ClassRule
        public static WireMockClassRule wireMockClassRule = new WireMockClassRule(wireMockConfig().port(CLASSRULE_HTTP_PORT).httpsPort(CLASSRULE_HTTPS_PORT));
    ...
    public static class RuleStubbing {
        ...
        @ClassRule
        public static WireMockClassRule serviceOne = new WireMockClassRule(wireMockConfig().port(PORT1));
        @ClassRule
        public static WireMockClassRule serviceTwo = new WireMockClassRule(wireMockConfig().port(PORT2));
        @Rule
        public WireMockRule serviceThree = new WireMockRule(wireMockConfig().port(PORT3));
        @Rule
        public WireMockRule serviceFour = new WireMockRule(wireMockConfig().port(PORT4));
